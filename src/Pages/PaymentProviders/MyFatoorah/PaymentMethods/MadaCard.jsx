...
export const MadaCard = ({
  ...
  useEffect(() => {
    const divID = document.getElementById("md-card-element");
    ...
    script.onload = () => {
      ...
      const config = {
        ...
        sessionId: sessionId,
        cardViewId: "md-card-element",
        supportedNetworks: "md",
        callback: (response) => {
  ...
  return <div id="md-card-element"></div>;
};
